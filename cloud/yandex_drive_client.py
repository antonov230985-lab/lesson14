"""Клиент Яндекс.Диска через REST API.

Файл инкапсулирует операции работы с файлом в Яндекс.Диске: чтение метаданных,
скачивание исходного xlsx и загрузка итогового файла с перезаписью.
"""

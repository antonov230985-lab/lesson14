"""Оркестратор обработки данных task1..task5.

Файл связывает CSV-листы с соответствующими модулями задач, запускает все этапы
очистки и возвращает набор итоговых DataFrame плюс путь к объединенному файлу.
"""
